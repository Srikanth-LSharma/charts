...
const initialData = [
    ...
    {
        category: 'B', value: 15, subData: [{
            category: 'B1', value: 7, subData: [
                { category: 'B11', value: 5 }, { category: 'B22', value: 7 }
            ]
        }, { category: 'B2', value: 8 }]
    },
    ...
    useEffect(() => {
        ...
        svg.selectAll('.bar')
            ...
            .on("mouseenter", (event, value) => {
                ...
                //     .selectAll(".tooltip")
                //     .data([value])
                //     .join((enter) => enter.append("text").attr("y", y(value) - 4))
                //     .attr("class", "tooltip")
                //     .text(value)
        ...
        const backButton = svg.select('.back-button').remove();
        ...
        if (history.length > 1) {
            ...
            svg.select('.back-button').selectAll('*').remove();
